...
<head>
    ...
    <meta name="description"
        content="The page you are looking for was not found. Return to the home page or check the URL for errors.">
    <meta name="keywords" content="404 Not Found, Error Page, Page Not Found">
    <meta name="author" content="AdoptACat Team">
    <meta name="robots" content="noindex, nofollow">

    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="404 Not Found - AdoptACat">
    ...
    <meta name="twitter:title" content="404 Not Found - AdoptACat">
    <meta name="twitter:description"
        content="The page you are looking for was not found. Return to the home page or check the URL for errors.">
    <meta name="twitter:image" content="https://via.placeholder.com/300">

    <title>404 Not Found - AdoptACat</title>
...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-300">
    <div class="flex items-center justify-center min-h-screen">
        <div class="text-center max-w-md mx-auto p-6">
            <!-- Image -->
            <img src="https://i.pinimg.com/originals/3c/21/77/3c217769347611cca2cf856df4830dd1.gif" alt="Not Found"
                class="w-64 h-64 mx-auto mb-6 rounded-xl shadow-lg">

            <!-- Title -->
            <h1 class="text-4xl font-bold mb-4 text-gray-800 dark:text-white">404 - Not Found</h1>
