        ...
        <div class="container mx-auto p-4">
            <div class="max-w-3xl mx-auto">
                <div class="text-center mb-6">
                    <h1 class="text-3xl font-semibold text-[#D6A760]">Share Stories and Tips!🐈</h1>
                </div>
                <form action="{{ route('blogs.store') }}" method="post" class="space-y-4" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text"
                            ...
                            name="title" id="title" placeholder="Enter the title of your blog" required>
                    </div>
